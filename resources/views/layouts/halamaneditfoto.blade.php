             ...
             <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        <strong>Judul:</strong>
                        <input type="text" name="nama" value="{{ $foto->nama }}" class="form-control" placeholder="Judul">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Deskripsi:</strong>
                        <textarea class="textarea" placeholder="Deskripsi" name="deskripsi" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required>{{ $foto->deskripsi }}</textarea>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
